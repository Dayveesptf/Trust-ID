...
const steps = [
  {
    ...
    desc: "Your everyday transactions, savings and payments",
    icon: "💳",
  },
  {
    step: "02",
    label: "TrustID Analysis",
    desc: "We analyse five key financial behaviour dimensions",
    icon: "🔍",
  },
  {
    step: "03",
    label: "Trust Profile",
    desc: "A transparent, explainable credibility score",
    icon: "🛡",
  },
  {
    step: "04",
    label: "Financial Growth",
    desc: "Personalised recommendations to strengthen your profile",
    icon: "📈",
  },
  {
    step: "05",
    label: "Better Lending Insight",
    desc: "Richer context to support financial institutions",
    icon: "🏦",
  },
];
...
const features = [
  {
    title: "What TrustID Does",
    body: "TrustID analyses your existing financial behaviour — how you earn, save, repay and manage money — and transforms it into a clear, explainable credibility profile. No guesswork. No black box.",
  },
  {
    title: "Why Behaviour Matters",
    body: "Traditional credit history isn't always available for young people. TrustID fills that gap by looking at how you actually manage money, not just whether you've had a loan before.",
  },
  {
    title: "How You Can Improve",
    body: "TrustID shows you exactly what drives your score and provides practical, supportive recommendations to help you build stronger financial habits over time.",
  },
  {
    title: "Supporting Finance Institutions",
    body: "TrustID provides Ecobank with additional behavioural insights to help analysts make more informed decisions. TrustID does not make lending decisions — Ecobank does.",
  },
];
...
export default function LandingPage({ navigate }: Props) {
  ...
  let primaryAction = () => navigate("signup");

  if (isAuthenticated && user) {
    if (isEcobankUser) {
      primaryLabel = "Ecobank Portal";
      primaryAction = () =>
  ...
  /*
   * Hero button uses the same action.
   */
  const heroButtonText = primaryLabel;
  const handleGetStarted = primaryAction;
  ...
  return (
    <div className="min-h-screen bg-white font-['DM_Sans',sans-serif]">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {!isAuthenticated ? (
              <>
                ...
                <button
                  onClick={() =>
                    navigate("ecobank-login")
                  }
                  className="hidden sm:block text-sm text-[#64748B] hover:text-[#0D2D52] font-medium transition-colors px-3 py-2"
                >
                  Ecobank Portal
                </button>
              </>
            ) : (
              <span className="hidden sm:block text-sm text-[#64748B] mr-1">
                Hi,{" "}
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-24 grid lg:grid-cols-2 gap-16 items-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg text-[#64748B] leading-relaxed mb-8 max-w-lg">
            TrustID turns your everyday financial behaviour into an
            explainable financial credibility profile — helping you and your
            financial institution see the full picture.
          </p>
          ...
          <p className="mt-5 text-xs text-[#94A3B8] flex items-center gap-2">
            ...
            No credit history required · Transparent scoring · Your data, your
            control
          </p>
        </div>
          ...
          <div className="bg-white rounded-3xl border border-[#E2EAF2] shadow-xl p-8 w-80">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-4xl font-bold text-[#0D1F35] font-['JetBrains_Mono',monospace] mt-1">
                  742
                </p>
              ...
              {[
                ...
                <div key={label}>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="text-[#0D1F35] font-semibold">
                      {val}/100
                    </span>
                  </div>
      ...
      <section
        id="how-it-works"
        className="bg-[#F8FAFB] border-y border-[#E2EAF2] py-20"
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-[#0D1F35] tracking-tight mb-3">
              How TrustID Works
            </h2>

            <p className="text-[#64748B] max-w-lg mx-auto">
              Five simple steps from financial behaviour to richer insight
            </p>
          </div>
              ...
              {steps.map((s, i) => (
                ...
                >
                  <div className="h-18 w-18 rounded-2xl bg-white border-2 border-[#E2EAF2] group-hover:border-[#0D2D52] transition-colors flex flex-col items-center justify-center mb-4 shadow-sm z-10 p-3">
                    ...
                    <span className="text-xs font-bold text-[#0D2D52] font-['JetBrains_Mono',monospace]">
                      {s.step}
                    </span>
                  </div>

                  <p className="text-sm font-bold text-[#0D1F35] mb-1.5">
                    {s.label}
                  </p>
      ...
      <section className="py-20 max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-[#64748B] max-w-lg mx-auto">
            A fairer, more transparent way to demonstrate financial
            credibility
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {features.map((f, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border border-[#E2EAF2] p-6 hover:shadow-md hover:border-[#C8D9EC] transition-all"
            >
              ...
              <h3 className="text-base font-bold text-[#0D1F35] mb-2">
                {f.title}
              </h3>
      ...
      <section className="bg-[#EFF4F9] border-y border-[#C8D9EC] py-8">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-sm text-[#0D2D52] font-medium">
            ...
            TrustID provides additional financial behaviour insights to support
            decision-making. TrustID does not approve or reject loans. Ecobank
            retains full responsibility for all final lending decisions.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 text-center max-w-2xl mx-auto px-6">
        <h2 className="text-3xl font-bold text-[#0D1F35] tracking-tight mb-4">
          Ready to build your Trust Profile?
        </h2>

        <p className="text-[#64748B] mb-8">
          Get started in minutes. Your financial behaviour tells a story — let
          TrustID help tell it clearly.
        </p>
        ...
        <p className="mt-4 text-xs text-[#94A3B8]">
          Free to use · No credit history needed · Transparent and explainable
        </p>
      </section>
      ...
      <footer className="border-t border-[#E2EAF2] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-[#94A3B8]">
            © 2026 TrustID · Competition Prototype · Simulated data only
          </p>
          ...
          <button
            ...
            className="text-xs text-[#64748B] hover:text-[#0D2D52] font-medium"
          >
            Ecobank Portal →
          </button>
        </div>
